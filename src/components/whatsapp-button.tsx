...
const WhatsAppButton = () => {
  ...
  return (
    <Link
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center gap-3 px-4 py-2 bg-background rounded-full shadow-lg hover:shadow-xl transition-shadow"
      >
        <div className="bg-[#25D366] rounded-full p-2">
            <WhatsAppIcon />
        </div>
        <span className="text-lg font-medium text-foreground pr-2">Need help?</span>
      </Link>
  );
};
